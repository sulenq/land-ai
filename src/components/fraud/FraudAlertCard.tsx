      ...
      <HStack justify="space-between" align="start">
        <Box flex={1}>
          <HStack gap={2} mb={2} wrap="wrap">
            <Badge colorScheme={sevConfig.colorScheme}>{alert.severity}</Badge>
        ...
        <Badge colorScheme={statusColor}>{alert.status}</Badge>
      </HStack>
          ...
          >
            <HStack justify="space-between" mb={2}>
              <P fontSize="xs" fontWeight="semibold" color="fg.muted">
                Ditemukan {alert.matchCount || alert.evidence.matches.length}{" "}
                tanda tangan mirip:
              </P>
