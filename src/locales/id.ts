const translations = {
  ...
  alert_da_analyze_failed: {
    ...
    description:
      "Terjadi kesalahan saat memproses dokumen. Silakan coba kembali.",
  },
  ...
  feedback: {
    ...
    success_message:
      "Terima kasih atas feedback Anda! Kami akan menggunakannya untuk meningkatkan layanan kami.",
  },
  ...
  msg_chat_ai_disclaimer:
    "Jawaban akan menyertakan dasar hukum (pasal / peraturan) jika tersedia. Pertanyaan tanpa referensi relevan dapat ditolak.",
  msg_chrome_permissions_settings_link:
    "Pengaturan → Privasi & Keamanan → Pengaturan Situs → ",
  msg_da_disclaimer:
    "*Data yang diunggah hanya digunakan untuk proses analisis dan akan dihapus setelah analisis selesai demi menjaga privasi pengguna.",
  msg_da_select_service_helper:
    "Silahkan pilih layanan yang ingin Anda gunakan.",
  ...
  msg_toggle_protect_session:
    "Status perlindungan sesi chat ini akan diubah. Saat dilindungi, sesi tidak dapat dihapus. Saat perlindungan dimatikan, sesi dapat dihapus kembali.",
  ...
  service_1_description:
    "Memeriksa keabsahan dan kesesuaian data sertipikat tanah secara cepat dan akurat.",
  service_1_title: "Pengecekan Sertipikat Tanah",
  service_2_description:
    "Dokumen informasi status pendaftaran tanah yang dibutuhkan dalam proses transaksi.",
  service_2_title: "Surat Keterangan Pendaftaran Tanah (SKPT)",
  service_3_description:
    "Pendaftaran hak tanggungan sebagai jaminan utang yang dilakukan secara elektronik.",
  service_3_title: "Hak Tanggungan Elektronik (HT-el)",
  service_4_description:
    "Penghapusan catatan hak tanggungan setelah kewajiban utang dinyatakan lunas.",
  service_4_title: "Roya (Manual & Elektronik)",
  service_5_description:
    "Proses perubahan kepemilikan sertipikat tanah akibat jual beli, hibah, atau waris.",
  service_5_title: "Peralihan Hak",
  service_6_description:
    "Pencatatan surat keputusan yang berkaitan dengan hak atas tanah seperti HGU atau HGB.",
  service_6_title: "Pendaftaran Surat Keputusan (SK)",
  service_7_description:
    "Konversi hak guna bangunan atau hak pakai menjadi hak milik sesuai ketentuan.",
  ...
  share_chat: {
    description:
      "Buat link publik untuk membagikan percakapan ini ke orang lain. Orang lain bisa melihat seluruh percakapan tanpa perlu sign in.",
    disclaimer:
      "Share link berhasil dibuat! Link ini bersifat publik dan bisa diakses oleh siapa saja.",
